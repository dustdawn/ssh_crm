					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<input type="text"  style="WIDTH: 180px" id="cust_name" value="<s:property value="#saleVisit.customer.cust_name" />"  readonly="true" />
									<input type="button" value="选择客户" onclick="window.open('${pageContext.request.contextPath}/CustomerAction_select','','width=600,height=300')" />
								</td>	
								<td>拜访时间 ：</td>
								<td  >
